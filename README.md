...
- [Dataset on Kaggle](https://www.kaggle.com/datasets/nelgiriyewithana/apple-quality)  

### `regression/` – House Prices Dataset  
- **Goal**: Predict house sale prices using regression models.  
- [Dataset on Kaggle](https://www.kaggle.com/c/house-prices-advanced-regression-techniques)  
